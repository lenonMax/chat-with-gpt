...
export const settingsUISlice = createSlice({
  ...
  reducers: {
    ...
    setTabAndOption: (
      state,
      action: PayloadAction<{ tab: string | null; option: string | null }>
    ) => {
...
export const selectSettingsOption = (state: RootState) =>
  state.settingsUI.option;

export const openOpenAIApiKeyPanel = () =>
  settingsUISlice.actions.setTabAndOption({ tab: 'user', option: 'apiKey' });
export const openElevenLabsApiKeyPanel = () =>
